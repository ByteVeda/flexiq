...
leaders responsible for enforcement at conduct@byteveda.org. All complaints will be reviewed and
investigated promptly and fairly.

All community leaders are obligated to respect the privacy and security of the reporter of any
incident.

**Who "community leaders" means here.** flexiq is maintained by ByteVeda, and ByteVeda handles
reports itself — there is no separate conduct committee to appeal to, and this document does not
pretend otherwise. Mail sent to `conduct@byteveda.org` is read by the maintainers. If a report
concerns a maintainer, say so in the mail; it will be handled by someone else on the team.
