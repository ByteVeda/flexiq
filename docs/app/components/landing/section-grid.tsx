 ...
 *
 * Built from `navForTier` — the same section list the sidebar renders, which is
 ...
 *
 * The SDK, not the tier: the root is only ever reached with a language
 * selected, and the server tier has its own landing at `/server` — the server
 * fold above this grid is what points at it.
 *
