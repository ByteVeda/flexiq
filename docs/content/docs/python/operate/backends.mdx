...
<Callout type="info">
  ...
  auto-cleanup](/python/operate/inspection#retention--auto-cleanup)
...
Python (see [Deployment](/python/operate/deployment#sqlite-scaling-limits))
...
see [WAL mode and backups](/python/operate/deployment#wal-mode-and-backups)
