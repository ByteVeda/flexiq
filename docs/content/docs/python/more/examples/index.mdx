---
title: Examples
description: "End-to-end examples demonstrating common flexiq patterns."
---
...
| [Batch Emails](/python/more/examples/bulk-emails) | High-throughput fan-out with in-memory task batching |
...
| [Benchmark](/python/more/examples/benchmark) | Performance benchmarks comparing flexiq to alternatives |
