...
defined in [`flexiq.notes`](https://github.com/ByteVeda/flexiq/blob/master/sdks/python/flexiq/notes.py):
...
Subclasses `FlexiQError` and `ValueError`. The exception message names
