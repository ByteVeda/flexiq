...
[Events guide →](/python/guides/extensibility/events)
...
[Prometheus integration →](/python/guides/integrations/prometheus)
...
[Middleware vs hooks](/python/guides/extensibility/middleware#middleware-vs-hooks).
