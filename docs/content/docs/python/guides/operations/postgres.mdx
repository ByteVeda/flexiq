...
| `FLEXIQ_DB_PATH` | `".taskito/taskito.db"` | SQLite database path (ignored with Postgres) |
...
Environment=FLEXIQ_DB_URL=postgresql://taskito:secret@db.internal:5432/myapp
