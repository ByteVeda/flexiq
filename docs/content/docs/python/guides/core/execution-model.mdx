...
```bash
flexiq worker --app myapp:queue --workers 8
```
...
For more details, see the [Prefork Pool guide](/python/guides/core).
...
For more details, see the [Native Async Tasks guide](/python/guides/core).
