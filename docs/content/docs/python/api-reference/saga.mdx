...
For the conceptual overview, see [Sagas](/python/modules/workflows/saga).
...
If the parent step has its own explicit `compensates=…`, that wins — no propagation happens. See [Sagas](/python/modules/workflows/saga) for a worked example.
