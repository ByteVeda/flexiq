...
<Cards>
  <Card
    ...
    href="/java/modules/injection/dependency-injection"
    description="FlexiQ.resource(), the five scopes, Resources.use, annotation-driven injection, teardown, metrics"
  />
  <Card
    title="Configuration"
    href="/java/modules/injection/configuration"
    description="The resource() overloads, choosing a scope, teardown, and PoolConfig tuning"
  />
  <Card
    title="Enqueue interception"
    href="/java/modules/injection/interception"
  ...
  <Card
    ...
    href="/java/modules/injection/proxies"
    description="Signed ProxyRefs for non-serializable values — HMAC signing, TTL, purpose binding, sessions"
  />
  <Card
    title="Observability"
    href="/java/modules/injection/observability"
    description="Reading resourceMetrics() — created/disposed/active counters"
  />
  <Card
    title="Testing"
    href="/java/modules/injection/testing"
    description="Registering stub resources with InMemoryFlexiQ"
  />
</Cards>
...
[proxies](/java/modules/injection/proxies) deconstruct them into signed,
