---
title: Core
description: "The building blocks of every Java flexiq application."
---
...
<Cards>
  ...
  <Card
    ...
    href="/java/guides/core/discovery"
    description="Declare handlers with @TaskHandler and load them with discover()"
  />
  <Card
