...
```java
import org.byteveda.flexiq.workflows.Canvas;
```
...
[Canvas guide](/java/modules/workflows/canvas).
...
[`FlexiQ.submitWorkflow`](/java/api-reference/queue), and build the worker
