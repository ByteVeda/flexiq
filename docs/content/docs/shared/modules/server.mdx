...
<SdkLink to="operate/server/grpc">the gRPC door</SdkLink> for the producer RPCs,
<SdkLink to="operate/server/tokens">API tokens</SdkLink> for the credential's
lifecycle, and
<SdkLink to="operate/server/grpc#the-executor-door">the executor door</SdkLink>
...
non-finite numbers, and anything JSON has no syntax for. See <SdkLink to="operate/server/grpc#two-doors-for-one-payload-and-only-one-of-them-is-lossless">the full treatment</SdkLink> for the one thing it silently normalises instead
