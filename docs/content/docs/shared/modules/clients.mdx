...
are covered in
<SdkLink to="operate/server/tokens">API tokens</SdkLink>.
...
<SdkLink to="operate/server/grpc#two-doors-for-one-payload-and-only-one-of-them-is-lossless">the full treatment</SdkLink>.
...
in
<SdkLink to="operate/server/grpc#the-same-door-without-grpc">The same door, without gRPC</SdkLink>,
and
