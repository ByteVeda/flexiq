...
[`serveDashboard`](/node/modules/dashboard) mounts a JSON REST API at
...
[`serveDashboard`](/node/modules/dashboard) for **session mode**:
...
<Callout type="warning">
  ...
  [Express](/node/guides/extend/express#dashboard) /
