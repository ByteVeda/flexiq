...
<Callout type="info">
  ...
  [`healthCheck`](/node/modules/injection/configuration#health-checks-and-recreation).
...
If you use [resource proxies](/node/modules/injection/proxies),
...
The [dashboard](/node/modules/dashboard) surfaces worker resources
