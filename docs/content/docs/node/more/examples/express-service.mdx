...
A thin Express front end accepts upload requests, enqueues a FlexiQ job, and
...
| Mounting a ready-made REST API | [`flexiqRouter`](/node/guides/integrations/express) |
