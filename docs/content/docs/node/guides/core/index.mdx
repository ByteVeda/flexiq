---
title: Core
description: "The building blocks of every Node.js flexiq application."
---
...
<Cards>
  ...
  <Card
    ...
    href="/node/guides/core/discovery"
    description="Declare tasks with task() and claim them with queue.discover()"
  />
  <Card
