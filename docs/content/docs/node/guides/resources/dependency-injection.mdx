...
Task- and request-scoped factories may depend on any scope.
...
// { db: { created: 1, disposed: 0, active: 1 }, tx: { created: 12, disposed: 12, active: 0 } }
```
...
See [testing](/node/guides/operations/testing) for the full worker test setup.
