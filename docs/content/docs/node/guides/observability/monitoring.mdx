...
The [dashboard](/node/guides/operations/dashboard), the
[KEDA scaler](/node/guides/operations/keda) server, and the
[Express](/node/guides/integrations/express) / [Fastify](/node/guides/integrations/fastify)
helpers all serve these same helpers on `/health` and `/readiness`.
