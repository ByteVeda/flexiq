...
|-------------|----------|---------|
| **<SdkLink to="guides/integrations">OpenTelemetry</SdkLink>** | Distributed tracing, correlating tasks with HTTP requests | `pip install flexiq[otel]` |
| **<SdkLink to="guides/integrations">Prometheus</SdkLink>** | Metrics dashboards, alerting on queue depth/error rates | `pip install flexiq[prometheus]` |
| **<SdkLink to="guides/integrations">Sentry</SdkLink>** | Error tracking with rich context and breadcrumbs | `pip install flexiq[sentry]` |
...
|-------------|----------|-------------|
| **<SdkLink to="guides/integrations">Micrometer</SdkLink>** (`FlexiQObservation`) | One instrumentation → both a metrics timer and a trace span | `io.micrometer:micrometer-observation` |
