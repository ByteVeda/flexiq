---
title: Failure Model
description: "At-least-once delivery semantics and how flexiq recovers from crashes, timeouts, and partial writes."
---

import { Callout } from "fumadocs-ui/components/callout";

FlexiQ provides **exactly-once dispatch** — `claim_execution` ensures two workers
