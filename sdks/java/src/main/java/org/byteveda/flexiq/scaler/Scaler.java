package org.byteveda.flexiq.scaler;
 ...
 * {@link #start(FlexiQ, ScalerOptions)} and {@link #close()} to stop.
 */
public final class Scaler implements AutoCloseable {
    ...
    private static void handleScaler(HttpExchange exchange, FlexiQ queue, ScalerOptions options) throws IOException {
