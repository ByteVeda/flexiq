 ...
 * }</pre>
 *
 * <p>Identical under a {@link org.byteveda.taskito.worker.Worker} and an
 * attached {@link org.byteveda.taskito.worker.Executor}, which is the whole
...
public final class JobContext {
    private static final TaskitoLogger LOG = TaskitoLogger.create("job");
