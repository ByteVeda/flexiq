...
runtimeOnly("org.byteveda:flexiq:2.0.0:linux-x86_64") // native library for your platform
annotationProcessor("org.byteveda:flexiq-processor:2.0.0") // compile-time TaskHandler bindings
```
...
dependencies {
    runtimeOnly("org.byteveda:flexiq:2.0.0:${osdetector.classifier}")
}
```
