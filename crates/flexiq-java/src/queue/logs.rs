...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_writeTaskLog<'local>(
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_getTaskLogs<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    job_id: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_getTaskLogsAfter<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    job_id: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_queryTaskLogs<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    task_name: JString<'local>,
