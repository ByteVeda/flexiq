...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_listDead<'local>(
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_retryDead<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_deleteDead<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    dead_id: JString<'local>,
...
/// or is not Running.
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_requeueJob<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_purgeDead<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    older_than_ms: jlong,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_listDeadByTask<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_purgeDeadByTask<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    task_name: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_purgeCompleted<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    older_than_ms: jlong,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_pauseQueue<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_listPausedQueues<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) -> jstring {
...
/// same keys.
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_reservedSettingPrefixes<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    ...
    guard(&mut env, std::ptr::null_mut(), |env| {
        let prefixes: Vec<String> = flexiq_core::RESERVED_SETTING_PREFIXES
            .iter()
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_getSetting<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    key: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_setSetting<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    key: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_setSettingIf<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    key: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_deleteSetting<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    key: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_listSettings<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) -> jstring {
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_effectiveRetention<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) -> jstring {
    guard(&mut env, std::ptr::null_mut(), |env| {
        let queue = unsafe { borrow_queue(handle) };
        match flexiq_core::scheduler::retention::read_effective_retention_json(
            &queue.storage,
            queue.namespace.as_deref(),
        )? {
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_dryRunRetention<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    ...
    guard(&mut env, std::ptr::null_mut(), |env| {
        ...
        let preview = match read_optional_string(env, &retention_json)? {
            ...
            None => flexiq_core::scheduler::retention::dry_run_reported_json(
                &queue.storage,
                queue.namespace.as_deref(),
                now_millis(),
            )?,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_replayJob<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    job_id: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_getReplayHistory<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    job_id: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_minContract<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) -> jint {
    guard(&mut env, 0, |_env| {
        let queue = unsafe { borrow_queue(handle) };
        Ok(flexiq_core::min_contract(&queue.storage)? as jint)
    })
}
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_setMinContract<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    level: jint,
    ...
    guard(&mut env, (), |_env| {
        ...
        flexiq_core::set_min_contract(&queue.storage, level)?;
        Ok(())
    })
}
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_migrate<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) -> jstring {
