//! JNI entry points backing `org.byteveda.flexiq.internal.NativeQueue`.
//!
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_open<'local>(
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_close<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) {
...
/// input order.
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_enqueueMany<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    task_name: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_getJob<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_getResult<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    job_id: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_cancel<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    job_id: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_requestCancel<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    job_id: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_isCancelRequested<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    job_id: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_setProgress<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    job_id: JString<'local>,
