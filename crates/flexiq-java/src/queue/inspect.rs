...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_stats<'local>(
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_statsByQueue<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_countPendingByQueue<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    queue_name: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_statsAllQueues<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) -> jstring {
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_listJobs<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_listJobsAfter<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    filter_json: JString<'local>,
    ...
    guard(&mut env, std::ptr::null_mut(), |env| {
        ...
        let next_cursor =
            flexiq_core::storage::cursor::next_cursor(&jobs, limit, |j| (j.created_at, &j.id));
        let page = PageView {
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_listArchivedAfter<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    limit: jlong,
    ...
    guard(&mut env, std::ptr::null_mut(), |env| {
        ...
        let next_cursor = flexiq_core::storage::cursor::next_cursor(&jobs, limit, |j| {
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_jobErrors<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_metrics<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_listWorkers<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) -> jstring {
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_listCircuitBreakers<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
) -> jstring {
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeQueue_jobDag<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    job_id: JString<'local>,
