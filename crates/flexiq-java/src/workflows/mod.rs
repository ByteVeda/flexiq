//! JNI entry points backing `org.byteveda.flexiq.internal.NativeWorkflows`.
//!
...
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_submitWorkflow<'local>(
...
/// non-workflow jobs).
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_markWorkflowNodeResult<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_getWorkflowStatus<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
/// `cancelled`.
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_cancelWorkflowRun<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_getWorkflowPlan<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    run_id: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_workflowNameForRun<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_workflowNodeForJob<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
#[allow(clippy::too_many_arguments)]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_expandFanOut<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    run_id: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_checkFanOutCompletion<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
#[allow(clippy::too_many_arguments)]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_createDeferredJob<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_cascadeSkipPending<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
/// `null`.
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_finalizeRunIfTerminal<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_setWorkflowNodeWaitingApproval<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_resolveWorkflowGate<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_setWorkflowNodeRunning<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_failWorkflowNode<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_skipWorkflowNode<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_setWorkflowNodeCacheHit<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_setWorkflowRunCompensating<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_setWorkflowRunCompensated<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_setWorkflowRunCompensationFailed<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_setWorkflowRunCompletedWithFailures<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
#[allow(clippy::too_many_arguments)]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_setWorkflowNodeCompensationJob<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_setWorkflowNodeCompensated<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
#[allow(clippy::too_many_arguments)]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_setWorkflowNodeCompensationFailed<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    ...
    for node in nodes {
        ...
        if let Some(job_id) = &node.job_id {
            if let Err(e) = queue.storage.cancel_job(job_id, queue.namespace.as_deref()) {
                log::warn!("[flexiq-java] cancel_job({job_id}) during workflow cascade: {e}");
            }
        }
        if let Err(e) =
            wf.update_workflow_node_status(run_id, &node.node_name, WorkflowNodeStatus::Skipped)
        {
            log::warn!("[flexiq-java] skip node '{}' failed: {e}", node.node_name);
        }
    }
}
...
#[no_mangle]
#[allow(clippy::too_many_arguments)]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_listWorkflowRuns<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_getWorkflowRun<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    run_id: JString<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_getWorkflowChildren<
    'local,
>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_org_byteveda_flexiq_internal_NativeWorkflows_getWorkflowDag<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    handle: jlong,
    run_id: JString<'local>,
