...
//!
//! ```bash
//! FLEXIQ_POSTGRES_TEST_URL=postgres://… cargo test -p flexiq-server --features postgres
//! FLEXIQ_REDIS_TEST_URL=redis://…       cargo test -p flexiq-server --features redis
//! ```
//!
...
use flexiq_server::config::backend;
